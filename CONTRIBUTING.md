...
Thank you for your interest in `strong-service-upstart`, an open source project
administered by StrongLoop.

Contributing to `strong-service-upstart` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/strong-service-upstart)
